<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <div class="main">
            ...
            <div class="heading">
                ...
                <div class="headingvalue right"><b>
                    <xsl:value-of select='format-number(Object/Summary/Total,"0.00")'/>
                    </b>
                </div>
            ...
            <div class="heading">
                ...
                <div class="headingvalue right" style="width:65%; display:flex;"><span style="align-self: flex-end;	width: 100%;"><xsl:value-of select="Object/PricePerUnit"/></span></div>&#160;&#160;&#160;
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="bold"><xsl:value-of select="Object/Summary/Building"/></td>
                    <td class="bold"><xsl:value-of select="Object/Summary/Mounting"/></td>
                    <td class="bold"><xsl:value-of select="Object/Summary/Equipment"/></td>
                    <td class="bold"><xsl:value-of select="Object/Summary/Other"/></td>
                    <td class="bold"><xsl:value-of select="Object/Summary/Total"/></td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/WorkersSalary"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">ЭМ</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/Machines"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent2"><i>в том чисте ОТм</i></td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/MachinistSalary"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">М</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/Materials"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">Перевозка</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/TransportTotal"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">НР</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/Overhead"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">СП</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Summary/Profit"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">оборудование</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Equipment/Total"/></td>
                </tr>				
                <tr>
                    <td colspan="2"></td>
                    <td class="left indent">прочие затраты</td>
                    <td colspan="4"></td>
                    <td class="bold"><xsl:value-of select="Object/Details/Other"/></td>
                </tr>				
            </table>
    ...
    <xsl:template match="LocalEstimate | TempBuildings | Additions  | Extra">
        ...
        <tr>
            ...
            <td><xsl:value-of select="Mounting"/></td>
    ...
    <xsl:template match="*[contains(name(), 'SubSummary')]">
        ...
        <tr>
            ...
            <td class="bold"><xsl:value-of select="Building"/></td>
            <td class="bold"><xsl:value-of select="Mounting"/></td>
            <td class="bold"><xsl:value-of select="Equipment"/></td>
            <td class="bold"><xsl:value-of select="Other"/></td>
            <td class="bold"><xsl:value-of select="Total"/></td>
        </tr>
    </xsl:template>
