	...
	<xsl:template match="Construction" mode="render">
		<div class="main">
			...
			<div class="heading" id="NormativeName">
				...
				<div class="headingvalue">
					<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/Salary)"/>
				</div>
			</div>
					...
					<div class="heading">
						...
						<div class="headingvalue right">
							<xsl:if test="Object/Estimate/EstimatePrice/Total != 0"> 
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/Total div 1000)"/>
							</xsl:if>
					...
					<div class="heading leftmargin">
						...
						<div class="headingvalue right">
							<xsl:if test="Object/Estimate/EstimatePrice/Building/Total != 0">
								...
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/Building/Total div 1000)"/>
							</xsl:if>
						</div>
						<div class="headingname">тыс. руб.</div>
					</div>
					<div class="heading leftmargin">
						...
						<div class="headingvalue right">
							<xsl:if test="Object/Estimate/EstimatePrice/Mounting/Total != 0">
								...
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/Mounting/Total div 1000)"/>
							</xsl:if>
						</div>
						<div class="headingname">тыс. руб.</div>
					</div>
					<div class="heading leftmargin">
						...
						<div class="headingvalue right">
							<xsl:if test="Object/Estimate/EstimatePrice/Equipment/Total != 0">
								...
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/Equipment/Total div 1000)"/>
							</xsl:if>
						</div>
						<div class="headingname">тыс. руб.</div>
					</div>
					<div class="heading leftmargin">
						...
						<div class="headingvalue right">
							<xsl:if test="Object/Estimate/EstimatePrice/OtherTotal != 0">
								...
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/OtherTotal div 1000)"/>
							</xsl:if>
						</div>
						<div class="headingname">тыс. руб.</div>
					</div>
					...
					<div class="heading">
						...
						<div class="headingvalue right">
							<xsl:if test="Object/Estimate/EstimatePrice/Summary/WorkersSalary != 0">
								...
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/Summary/WorkersSalary div 1000)"/>
							</xsl:if>
						</div>
					</div>
					<div class="heading">
						...
						<div class="headingvalue right" style="white-space: nowrap;">
							<xsl:if test="Object/Estimate/EstimatePrice/Summary/MachinistSalary != 0">
								...
								<xsl:value-of select="util:formatNumberWithZeroCheck(Object/Estimate/EstimatePrice/Summary/MachinistSalary div 1000)"/>
							</xsl:if>
						</div>
					</div>
					<div class="heading">
...
<!--							<i>в том числе</i>-->
					...
					<tr>
						...
						<td>
							<xsl:value-of select="util:formatNumberWithSevenDecimals(Summary/LaborCosts)"/>
						</td>
					</tr>
					<tr>
						<td colspan="2"/>
						...
						<td>
							<xsl:value-of select="util:formatNumberWithSevenDecimals(Summary/MachinistLaborCosts)"/>
						</td>
					</tr>
					<xsl:if test="Commissioning/Idle/Total != 0">
						...
						<tr>
							...
							<td class="bold">
								<xsl:value-of select="util:formatNumberWithZeroCheck(Commissioning/Idle/Total)"/>
							</td>
						</tr>
						<tr>
							<td colspan="2"/>
					...
					<xsl:if test="Commissioning/UnderLoad/Total != 0">
						<tr>
							...
							<td class="bold"> 
								<xsl:value-of select="util:formatNumberWithZeroCheck(Commissioning/UnderLoad/Total)"/>
							</td>
						</tr>
						<tr>
							<td colspan="2"/>
	...
	<xsl:template match="Item" mode="comissioning">
		...
		<tr>
			...
			<td/>
			<td>
				<xsl:value-of select="util:formatNumberWithSevenDecimals(Quantity)"/>
			</td>
			<td/>
			<td/>
			<td/>
	...
	<xsl:template match="*" mode="SummaryElement">
		<td>
			<xsl:if test=". != 0">
				<xsl:value-of select="util:formatNumberWithZeroCheck(.)"/>
			</xsl:if>
		</td>
	</xsl:template>
	...
	<xsl:template match="Item">
		...
		<tr>
			...
			<td class="btop"/>
			<td class="btop">
				<xsl:value-of select="util:formatNumberWithZeroCheck(./TotalsUnit/Current)"/>
			</td>
			<td class="btop"/>
			<td class="btop bold">
	...
	<xsl:template match="Cost">
		...
		<tr>
			...
			<td>
				<xsl:value-of select='util:formatNumberWithZeroCheck(./Coefficients/Final[./Scope = "Объем"]/Values/Value[./Target = "Объем"]/CoefValue)'/> 
				<xsl:value-of select='util:formatNumberWithZeroCheck(./Coefficients/Final/Values/Value[./Target = "Объем"]/CoefValue)'/> 
			...
			<td id="{concat('QuantityTotal',Num)}">
				...
				<xsl:value-of select="util:formatNumberWithSevenDecimals(./QuantityTotal)"/>
			</td>
			<td/>
			<td/>
			<td/>
...
<!--					<xsl:when test="$firstMachinistValue/Target = 'Расход'"><xsl:value-of select="$firstMachinistValue/Formula"/><br/></xsl:when>-->
		...
		<xsl:if test="./Totals/Current/WorkersSalary != 0">
			<tr>
				...
				<td/>
				<td>
					<xsl:value-of select="util:formatNumberWithSevenDecimals(./Totals/Natural/LaborCosts)"/>
				</td>
				<td/>
				<td/>
				<td/>
		...
		<xsl:if test="./Totals/Current/MachinistSalary != 0">
			<tr>
				...
				<td/>
				<td>
					<xsl:value-of select="util:formatNumberWithSevenDecimals(./Totals/Natural/MachinistLaborCosts)"/>
				</td>
				<td/>
				<td/>
				<td/>
		...
		<xsl:if test="./PerUnit/Natural/LaborCosts != 0">
			<tr>
				...
				<td>
					...
					<xsl:value-of select="util:formatNumberWithZeroCheck(./Coefficients/Final/Values/Value[./Target = $target]/CoefValue)"/>
				</td>
				<td>
					<xsl:value-of select="util:formatNumberWithSevenDecimals(./Totals/Natural/LaborCosts)"/>
				</td>
		...
		<tr>
			...
			<td class="btop"/>
			<td class="btop">
				<xsl:value-of select="util:formatNumberWithZeroCheck(./Totals/Current/Direct)"/>
			</td>
		</tr>
	</xsl:template>
...
<!--				<xsl:value-of select="./Coefficients/Final/Values/Value[./Target = &quot;Расход&quot;]/CoefValue"/>-->
	...
	<xsl:template match="Machinist" mode="machinist">
		<tr>
			...
			<td class="left">ОТм (ЗТм) Средний разряд машинистов <xsl:value-of select="util:formatNumberNoRounding(./Grade)"/></td>
			<td class="center">
				<xsl:value-of select="./Unit"/>
			</td>
			<td>
