<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:util="http://www.gge.ru/utils" exclude-result-prefixes="xs" version="2.0">
	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<xsl:apply-templates select="LocalEstimateResourceIndexMethod" mode="render"/>
				<xsl:apply-templates select="LocalEstimateResourceIndexMethod" mode="validate"/>
			</body>
		</html>
	</xsl:template>
	...
	<!-- Стройка -->
	<xsl:template match="LocalEstimateResourceIndexMethod" mode="render">
		<div class="main">
...
'/>
	...
	<xsl:template match="Item">
		...
		<xsl:apply-templates select="Material | Equipment | Transport | Other" mode="ext"/>
...
<!--				<br/> Кол-во =<xsl:value-of select="../../QuantityFormula"/> <xsl:value-of select="' '"/>-->
	...
	<xsl:template match="LocalEstimateResourceIndexMethod" mode="validate">
