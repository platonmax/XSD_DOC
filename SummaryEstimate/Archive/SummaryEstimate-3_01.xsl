<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:util="http://www.gge.ru/utils" exclude-result-prefixes="xs" version="2.0">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                <style type="text/css" id="styles"> 
                    ...
                    div.heading-left2 { margin-left:1.7em; display:flex; white-space: nowrap;  flex-wrap: nowrap; width:30%; margin-top: 0.5em; min-height: 1em;}
    ...
    <xsl:template match="Construction" mode="render">
        <div class="main">
            ...
            <div class="heading">
                <div class="headingname">Заказчик</div>
                <div class="headingvalue"><xsl:value-of select="Customer"/></div>
            </div>

            <div class="heading-left2">
                <div class="headingname">Утвержден</div>
            ...
            <div class="heading-left2">
                <div class="headingname"><b>Сводный сметный расчет сметной стоимостью</b></div> 
            ...
            <div class="heading-left3">
                <div class="headingname">Руководитель проектной организации</div>
                <div class="headingvalue center">
                    <xsl:value-of select="Signatures/ProjectOrg/Name"/>
                </div>
            </div>
            ...
            <div class="heading-left3">
                ...
                <div class="headingvalue center">
                    <xsl:value-of select="Signatures/ChiefProjectEngineer/Name"/>
                </div>
            </div>
            <div class="heading-left3" style="margin-top: 0;">
                <div class="helptext center">[подпись (инициалы, фамилия)]</div>
